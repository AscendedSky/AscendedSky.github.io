...
{% include image-gallery.html images="/_projects/Opamp_Bandstop/HPF_schematic.png" height="400" %}
...
{% include image-gallery.html images="/_projects/Opamp_Bandstop/simulated_filter_response.png" height="400" %}
<span style="font-size: 10px">LTspice Simulation – Frequency Response</span>

{% include image-gallery.html images="/_projects/Opamp_Bandstop/simulated_spectrum.png" height="400" %}
...
{% include image-gallery.html images="/_projects/Opamp_Bandstop/HPF_filter_response.png" height="400" %}
<span style="font-size: 10px">Actual Frequency Response of HPF</span>

{% include image-gallery.html images="/_projects/Opamp_Bandstop/breadboard.jpg" height="400" %}
...
{% include image-gallery.html images="/_projects/Opamp_Bandstop/real_filter_response.png" height="400" %}
<span style="font-size: 10px">Measured Frequency Response: 12 dB Attenuation at 5 kHz</span>

{% include image-gallery.html images="/_projects/Opamp_Bandstop/real_spectrum.png" height="400" %}
