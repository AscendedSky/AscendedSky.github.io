...
<img src="/_projects/Opamp_Bandstop/HPF_schematic.png" alt="3rd-Order Chebyshev High-Pass Filter Schematic" height="400"> <span style="font-size: 10px">Circuit Schematic – 3rd-Order Chebyshev High-Pass Filter</span>
...
<img src="/_projects/Opamp_Bandstop/simulated_filter_response.png" alt="LTspice Simulation Frequency Response" height="400"> <span style="font-size: 10px">LTspice Simulation – Frequency Response</span> <img src="/_projects/Opamp_Bandstop/simulated_spectrum.png" alt="LTspice Simulation Spectrum" height="400"> <span style="font-size: 10px">LTspice Simulation – Spectrum</span>
...
<img src="/_projects/Opamp_Bandstop/HPF_filter_response.png" alt="Actual Frequency Response of HPF" height="400"> <span style="font-size: 10px">Actual Frequency Response of HPF</span> <img src="/_projects/Opamp_Bandstop/breadboard.jpg" alt="Breadboard Setup HPF Only" height="400"> <span style="font-size: 10px">Hardware Implementation – Breadboard Setup (HPF Only)</span>
